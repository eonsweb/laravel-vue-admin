  ...
  <div class="min-h-screen">
    <div class="mb-6 flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-muted-foreground">Manage application users and permissions</p>
      </div>
    ...
    cell: ({ row }) => {
      return h(
        RouterLink,
        {
          ...
          class:
            'text-left tx-sm text-foreground hover:bg-secondary block w-full h-full px-2 py-1 rounded',
        },
        () => row.getValue('name'),
      )
    },
